...
| `petekio` | DATA | [docs.rs/petekio/0.3.4](https://docs.rs/petekio/0.3.4) |
| `petekstatic` | GEOMODEL | [docs.rs/petekstatic/0.1.7](https://docs.rs/petekstatic/0.1.7) |
| `peteksim` | SIMULATION | [docs.rs/peteksim/0.1.5](https://docs.rs/peteksim/0.1.5) |
