...
| Crate | Layer | docs.rs |
|---|---|---|
| `petektools` | TOOLKIT | [docs.rs/petektools/0.2.15](https://docs.rs/petektools/0.2.15) |
| `petekio` | DATA | [docs.rs/petekio/0.3.15](https://docs.rs/petekio/0.3.15) |
| `petekstatic` | GEOMODEL | [docs.rs/petekstatic/0.1.13](https://docs.rs/petekstatic/0.1.13) |
| `peteksim` | SIMULATION | [docs.rs/peteksim/0.1.13](https://docs.rs/peteksim/0.1.13) |
